...
export default function ProductCard({
  ...
  return (
    <article
      className={`rounded-3xl bg-neutral-900/80 ring-1 ring-neutral-800 p-3 shadow-lg ${
    ...
    >
      ...
      <div className="mt-3 flex items-center gap-3 px-1 pb-1">
        <Link
          ...
          className="grid h-11 w-11 place-items-center rounded-2xl bg-neutral-800 ring-1 ring-neutral-700 text-white hover:bg-neutral-700"
        >
